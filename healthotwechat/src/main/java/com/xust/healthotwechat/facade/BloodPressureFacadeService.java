...
public class BloodPressureFacadeService {
    ...
    public int entryBloodPressure(BloodPressureForm bloodPressureForm){
        ...
        try {
            ...
            String key = bloodPressureForm.getEmail()+"bloodPressure";
            ...
            /**redis中加入标记表示三天内录入过*/
            redisTemplate.opsForValue().set(bloodPressureForm.getEmail()+"_three_entry_bloodPressure",
     ...
     * @return
     */
    public List<BloodPressureDto> findBloodPressureList(String email){
        ...
        try {
            ...
            /**查询历史记录*/
            List<BloodPressure> bloodPressureList = bloodPressureService.findBloodPressureList(email);
            ...
            log.error("血压历史记录查询={}",email+":"+e.getMessage());
            throw e;
        }
