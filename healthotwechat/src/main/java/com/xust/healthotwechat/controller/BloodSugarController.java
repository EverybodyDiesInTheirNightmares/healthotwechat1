...
public class BloodSugarController {
    ...
    public String entry(@Valid BloodSugarForm bloodSugarForm,
        ...
        try {
            ...
            log.error("录入血糖={}",bloodSugarForm.getEmail()+e.getMessage());
    ...
    public ResultVO<List<BloodSugarDto>> getData(HttpServletRequest request){
        ...
        try {
            ...
            historyList = bloodSugarFacadeService.findBloodSugarListByOpenid(email);
     ...
     */
    @PostMapping("/custody")
    public ResultVO<List<BloodSugarDto>> custodyHistory(@RequestParam("email") String email,
